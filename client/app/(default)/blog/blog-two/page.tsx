...
import BlogTwoSection from '@/components/custom/blog-two-section'
import helper from '@/lib/helper'
import { Metadata } from 'next'
import React from 'react'

export const metadata: Metadata = {
    title: 'Blog style two | Cryzion',
    description:
    ...
    openGraph: {
        ...
        url: process.env.NEXT_PUBLIC_APP_URL + '/blog/blog-two',
        title: 'Blog style two | Cryzion',
    },
    twitter: {
    ...
    alternates: {
        canonical: `${process.env.NEXT_PUBLIC_APP_URL}/blog/blog-two`,
    },
}
        ...
        <>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    ...
                    "@context": "https://schema.org",
                    "@type": "WebSite",
                    "name": "Blog two | Cryzion",
                    "url": "${process.env.NEXT_PUBLIC_APP_URL}/blog-two",
                    ...
                    "breadcrumb": {
                        ...
                        },
                        {
                            ...
                            "position": 2,
                            "name": "Blog two | Cryzion",
                            "item": "${process.env.NEXT_PUBLIC_APP_URL}/blog-two"
                        }
                        ]
                    },
